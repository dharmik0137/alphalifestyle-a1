export const products = [
  {
    ...
    descriptionHtml: "<h2 style='text-align:center'>📦 Fastest Delivery! 2-5 Days </h2><p>🚀  No Delays </p><p> Trusted by Google ⭐</p>",
    images: [
      {
        src: "/product1-1.webp",
        position: 1
  ...
  },
  {
    ...
    descriptionHtml: "<p>📦 PREMIUM MATERIAL</p><p>🚀  CAPTURING FASHION FROM ALL ANGELES</p><p> FASHION FROM EXQUISITE DETAILS</p><p> PERFECT FOR EVERY MOMENT</p><p> PERFECT GIFT FOR A FASHIONISTA</p>",
    images: [
      {
        src: "/product2-1.jpg",
        position: 1
